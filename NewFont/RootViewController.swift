...
//  NewFont
//
//  Created by Jason Mendez on 3/8/17.
...
class RootViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let preferredTableFontView = UIFont.preferredFont(forTextStyle: UIFontTextStyle.headline)
        cellPointSize = preferredTableFontView.pointSize
